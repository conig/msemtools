...
get_haiku = function(){
  ...
  adjective_3 = c("discouraged","tremulous","reflective")
  ad_verb_3 = c("mournfully","peacefully","painfully")
  ...
  verb_2 = c("wailing","bouncing","sliding","smoking","hanging","warming")
  ...
  size_1 = c("Big","Small")
  objects_1 = c("legs","fists","doors")
  objects_2 = c("pebbles", "peanuts","poppers","doughnuts","talons","saphires")
  ...
  two = c("##colours_2## ##plural_objects_1## ##object_verb_2## softly...",
          ...
          "Dark ##nature_plural_1##; shrouded in ##mental_2##...",
          "Black ##nature_plural_1##, stinging my wide eyes...",
          "##colours_1## ##plural_animals_2## ##verb_2## ##plural_objects_1##...")
  three = c("##nature_plural_1## fall silently...",
            "##plural_animals_2## ##verb_1## lazily...",
            "##names_1## has ##possessed_3##...",
            "Some ##animal_1## with a leer...",
            "A boggle-eyed ##animal_1##...",
            "A scary notion...",
