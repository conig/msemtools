#' prisma
#'
#' Create a PRISMA diagram for a meta-analyis

#' @param database n from original database
#' @param additional_records how many additional references
#' @param duplicates_removed how many after duplicates removed
#' @param abstract_screened how many were title and abstract screened
#' @param ft_screened how many were full text screened
...
ft_exclude = ft_screened - final
abstract_excluded = abstract_screened - ft_screened
